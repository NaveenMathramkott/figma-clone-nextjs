...
const RenderSelect = ({
  ...
  >
    <SelectTrigger className="no-ring w-full rounded-sm border border-primary-grey-200 rounded-m">
      <SelectValue
        placeholder={
          config.property === "fontFamily"
            ? "Choose a font"
    ...
    <SelectContent className="border-primary-grey-200 bg-primary-black text-primary-grey-300 rounded-m">
